...
public class MemOccupyUtil {
    ...
    public MemOccupyUtil(byte nullReferenceSize, byte emptyObjectSize, byte emptyArrayVarSize) {
    ...
    public static MemOccupyUtil forJRockitVM() {
        return new MemOccupyUtil((byte) 4, (byte) 8, (byte) 8);
    }

    public static MemOccupyUtil forSun32BitsVM() {
        return new MemOccupyUtil((byte) 4, (byte) 8, (byte) 4);
    }

    public static MemOccupyUtil forSun64BitsVM() {
        return new MemOccupyUtil((byte) 8, (byte) 16, (byte) 8);
    }

    public static MemOccupyUtil forDetectedVM() {
        return null;
    }
