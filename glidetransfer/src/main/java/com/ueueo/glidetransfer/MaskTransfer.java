...
import com.ueueo.glidetransfer.internal.Utils;

public class MaskTransfer implements Transformation<Bitmap> {
   ...
   */
  public MaskTransfer(Context context, int maskId) {
    this(context, Glide.get(context).getBitmapPool(), maskId);
  }

  public MaskTransfer(Context context, BitmapPool pool, int maskId) {
    mBitmapPool = pool;
