...
public class RoundCornerTransfer implements Transformation<Bitmap> {
  ...
  public RoundCornerTransfer(Context context, int radius, int margin) {
    this(context, radius, margin, CornerType.ALL);
  }

  public RoundCornerTransfer(BitmapPool pool, int radius, int margin) {
